...
class ProfanityWordSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $fil_words = [
            'amputa', 'animal ka', 'bilat', 'binibirocha', 'bobo', 'bogo', 'bowet', 'bulbul', 'buset', 'chupa', 'ebak', 'etits', 'gago', 'habal', 'hayop ka', 'hindot', 'hiwal', 'hudas', 'iniyot', 'iyot', 'kagaguhan', 'kaguhan', 'kalibugan', 'kaltok', 'kantot', 'kantutan', 'kiki', 'kupal', 'leche', 'lintik', 'lolo mo', 'lulu', 'maniac', 'masturbate', 'mamatay', 'mamatay-matay', 'matay', 'mura', 'nguso', 'pakshet', 'pakyaw', 'palamura', 'pampam', 'panira', 'pantot', 'pepe', 'peste', 'pesteng yawa', 'puke', 'puking', 'puking ina mo', 'pukurit', 'puring', 'puta', 'putang', 'putang ina', 'putang ina mo', 'putanginamo', 'ratbu', 'shunga', 'sira', 'sira ulo', 'tarantado', 'tae', 'tanga', 'tibo', 'tite', 'titi', 'tungaw', 'ulol', 'ungas', 'yari', 'yawa'
        ];

        foreach ($en_words as $word) {
            ProfanityWord::firstOrCreate(['word' => strtolower($word)], ['language' => 'en', 'type' => 'profanity']);
        }

        foreach ($es_words as $word) {
            ProfanityWord::firstOrCreate(['word' => strtolower($word)], ['language' => 'es', 'type' => 'profanity']);
        }

        foreach ($fil_words as $word) {
            ProfanityWord::firstOrCreate(['word' => strtolower($word)], ['language' => 'fil', 'type' => 'profanity']);
        }
    }
}
